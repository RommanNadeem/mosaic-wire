...
export default function middleware(request) {
  ...
  // For non-crawlers, don't return anything to pass through normally
  // The request will continue to the SPA
}
...
export default async function middleware(request) {
  ...
  // For non-crawlers, fetch and return the original response
  // This ensures the SPA loads normally
