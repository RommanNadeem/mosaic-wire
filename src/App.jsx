...
function App() {
  ...
  const getTextClass = () => {
    return theme === "light"
      ? "text-ground-text-dark-primary"
      : "text-ground-text-primary";
  };
  ...
  if (error && newsData.length === 0) {
    return (
      <div className={`min-h-screen ${getBackgroundClass()}`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div
            className={`${getCardBgClass()} border border-red-500 rounded-lg p-4`}
          >
        ...
        <div
          className={`${
            theme === "light"
              ...
              : "bg-ground-dark-secondary border-ground-dark-tertiary"
          } border-b`}
        >
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-1">
        {newsData.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            {error && (
              <div
                className={`mt-4 ${getCardBgClass()} border border-red-500 rounded-lg p-4 max-w-md mx-auto`}
              >
